...
const searchBarInput = document.getElementsByClassName('search__bar')[0];
...
function onSuggestionsResponse(data) {
  ...
  if (suggestionsHTML) {
    ...
    searchBarInput.classList.add('search__bar--autosuggest');
  } else {
    actionsElement.classList.remove('search__actions--autosuggest');
    searchBarInput.classList.remove('search__bar--autosuggest');
  }
}
